...
pick( OFFSET_MAGNITUDE_TOO_LARGE,  "Offset magnitude too large for specified size (e.g. try to fits a word into a byte)" )
...
pick( CANNOT_USE_16BIT_REG_WITH_32BIT_ADDR,  "Cannot use 16-bit register with a 32-bit address" )
